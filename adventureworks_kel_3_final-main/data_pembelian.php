                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
          $sql = 'SELECT   dp.Name as NamaProduk, fp.StockedQty ,dv.Name as NamaVendor, ds.Name as Metode, dw.tgllengkap 
          from dim_produk dp 
          join fakta_penjualan fp on dp.ProductID = fp.ProductID 
          join dim_vendor dv on fp.VendorID = dv.VendorID
          join dim_shipmethod ds on fp.ShipMethodID = ds.ShipMethodID 
          join dim_waktu dw on fp.time_id = dw.time_id ;';
