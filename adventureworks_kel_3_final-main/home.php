    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <p>Welcome to Dashboard Adventure Works Kelompok 3</p>
                <center>
			<div class="row">
              ...
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                     <a  href="barchartpegawai.php"> <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><h4>Stok Produk Wilayah Tertinggi </br>$39422 </h4></div>
