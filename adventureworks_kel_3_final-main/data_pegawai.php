                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseWilayah" aria-expanded="false" aria-controls="collapseWilayah">
                            ...
                            <div class="collapse" id="collapseWilayah" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="data_wilayah.php">Data Wilayah</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Wilayah Penjualan</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="home.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Data Wilayah Penjualan</li>
                        </ol>
                        <div class="card mb-4">
                        </div>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
          $sql = 'SELECT s.StateProvinceID, s.Negara, s.STATEPROVINSI
				  FROM dim_sales_teritory s;';

          $query = mysqli_query($conn, $sql);

          while ($row = mysqli_fetch_array($query)) {
            echo '<tr>
	    		<td>' . $row['StateProvinceID'] . '</td>
		    	<td>' . $row['Negara'] . '</td>
                <td>' . $row['STATEPROVINSI'] . '</td>
